...
const CLUSTER_MOCUP : ClusterModel = {
  '1' :{clusterId: '1', clusterName:'test1', clusterType : 'coin', coolumns: 1, rows: 1, money : [
...
export class ClusterService {
 ...
 public currentGridCollection: Signal<MoneyModel[]> = computed(() => this.cluster()[this.selectedClusterId()]?.money);
